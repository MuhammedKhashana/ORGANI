        ...
        <div>
            <Fade duration={'500'}>
                <div className='my-3 d-flex flex-row justify-content-between align-items-center'>
                    <Text className='' size='3' weight='bold'>Your Tasks</Text>
                    <Dialog.Root>
                        <Dialog.Trigger className='d-flex justify-content-end'>
                            <Button variant='surface' color='gray' className='mx-0 p-0'><PlusLg size='20' className='mx-2' /></Button>
                        </Dialog.Trigger>
            ...
            <Zoom duration={'300'}>
                {
                    (taskS.length !== taskS.filter((task) => task.data.isCompleted == true).length)
                        ...
                        <Card >
                            {
                                taskS.filter((task) => task.data.isCompleted === false).map((task) =>
                                (
                                        ...
                                        <div className='mb-3'>
                                            <div className='d-flex flex-row justify-content-between align-items-center'>
                                                <div className='d-flex flex-column justify-content-between'>
                                                    ...
                                                    <div>
                                                        <Badge mr={'3'}
                                                            color={task.data.priority === 'normal' ? 'indigo'
                                                                :
                                                                (task.data.priority === 'weak') ? 'green' : 'tomato'
                                                            }>
                                                            <Text size={'1'} weight={'light'}>{task.data.priority}</Text>
                                                        </Badge>
                                                        <Text size={'2'} weight={'light'}>{task.data.date.toDateString()}</Text>
                                                    </div>
                                                </div>
                                                <div>
                                                    <Dialog.Root>
                                                                ...
                                                                <div className='w-100 mt-2 d-flex flex-row justify-content-between align-items-center'>
                                                                    <label className='w-50 d-flex flex-row justify-content-between align-items-center'>
                                                                        ...
                                                                        <TextField.Root
                                                                            ...
                                                                            type='date'
                                                                            ref={newDate}
                                                                            defaultValue={`${task.data.date.getFullYear()}` + '-' + `${String(task.data.date.getMonth() + 1).padStart(2, '0')}` + '-' + `${String(task.data.date.getDate()).padStart(2, '0')}`}
                                                                            placeholder="Enter Your Task Description"
                                                                        />
                                                                    </label>
                                ...
                                <Accordion.Item eventKey="0" className=''>
                                    ...
                                    <Accordion.Body className=''>
                                        <Fade duration={'300'} cascade>
                                            {
                                                taskS.filter((task) => task.data.isCompleted === true).map((task) =>
                                                (
